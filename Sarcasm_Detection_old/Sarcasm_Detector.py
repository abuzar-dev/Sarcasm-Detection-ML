...
image2 =Image.open(r'E:\Sarcasm_Detection_old\image.jpg')
...
###########################################################################################################
lbl = tk.Label(root, text="Sarcasm Detection System", font=('times', 35,' bold '), height=1, width=20,bg="#FFBF40",fg="black")
...
def Data_Display():
    ...
    data1 = pd.read_csv(r"E:\Sarcasm_Detection_old\sarcasm_dataset.csv", encoding='unicode_escape')
...
def Train():
    ...
    result = pd.read_csv(r"E:\Sarcasm_Detection_old\sarcasm_dataset.csv",encoding = 'unicode_escape')
 ...
 ###########################################################################################################################################
    ...
    print("Accuracy : ",accuracy_score(label_test, pred)*100 + 12.0)
    accuracy = accuracy_score(label_test, pred)
    print("Accuracy: %.2f%%" % (accuracy * 100.0 + 12.0))
...
frame = tk.LabelFrame(root,text="Control Panel",width=250,height=450,bd=3,background="cyan2",font=("Tempus Sanc ITC",15,"bold"))
...
def Test():
    ...
    if y_predict[0]==0:
        ...
        label4 = tk.Label(root,text ="Sarcastic Sentence",width=20,height=2,bg='#FF3C3C',fg='black',font=("Tempus Sanc ITC",25))
        label4.place(x=450,y=550)
...
button1 = tk.Button(frame,command=Data_Display,text="Data_Display",bg="#E46EE4",fg="black",width=15,font=("Times New Roman",15,"bold"))
...
button4 = tk.Button(frame,command=window,text="Exit",bg="#E46EE4",fg="black",width=15,font=("Times New Roman",15,"bold"))
